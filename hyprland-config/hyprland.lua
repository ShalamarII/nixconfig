...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {theme.borderActive1, theme.borderActive2}, angle = 45 },
...
hl.bind(mainMod .. " + page_up", hl.dsp.window.fullscreen({ action = "toggle" }))
